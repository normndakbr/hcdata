    ...
    //     })
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.statusCode==200){
                    $("#perGradeData").val(data.prs).trigger('change');
                } else {
                    $("#perGradeData").val('').trigger('change');
                }
            },
            error: function(xhr, ajaxOptions, thrownError) {
                $.LoadingOverlay("hide");
        ...
        $("#perGradeData").change(function(){
            let prs = $("#perGradeData").val();
            ...
            tbmGrade = $('#tbmGrade').DataTable({
                ...
                "ajax": {
                    "url": site_url+"grade/ajax_list?auth_per="+prs,
                    "type": "POST",
        ...
        $('#perGrade').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: site_url+"level/get_by_authper",
                data: {
                    auth_per: auth_per
                },
                success: function(data) {
        ...
        $("#btnTambahGrade").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: site_url+"grade/input_grade",
                data: {
                    prs: prs,
                    level: level,
                    grade: grade,
            ...
            if (authgrade == "") {
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: site_url+"Grade/hapus_Grade",
                            data: {
                                authgrade: authgrade
                            },
                            timeout: 20000,
        ...
        $(document).on('click', '.dtlgrade', function() {
            ...
            if (authgrade == "") {
                ...
                $.ajax({
                    type: "post",
                    url: site_url+"Grade/detail_Grade",
                    data: {
                        authgrade: authgrade
                    },
                    timeout: 15000,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (dataGrade.statusCode == 200) {
                            $.ajax({
                                type: "POST",
                                url: site_url+"level/get_by_idper",
                                success: function(data) {
        ...
        tbmGrade = $('#tbmGrade').DataTable({
            ...
            "ajax": {
                "url": site_url+"grade/ajax_list?auth_per="+$("#perGradeData").val(),
                "type": "POST",
                "error": function(xhr, error, code) {
                    if (code != "") {
                        $(".err_psn_grade").removeClass("d-none");
