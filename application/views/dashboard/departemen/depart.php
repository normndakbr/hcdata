                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        ...
                                        <a id="addbtn" href="<?= base_url('departemen/new'); ?>" class="btn btn-success font-weight-bold"><i class="fas fa-plus"></i> Tambah Data</a>
                                   </div>
                              </div>
                              <div class="row ">
                                   <?php
                                   ...
                                   <div class="col-lg-6 col-md-12 col-sm-12 mt-2">
                                        ...
                                        <select id='perDepartData' name='perLanggarData' class=" form-control form-control-user">
