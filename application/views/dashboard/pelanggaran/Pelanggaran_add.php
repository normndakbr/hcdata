               ...
               <div class="col-xl-12 col-md-12">
                    <div class="card latest-update-card">
                         ...
                         <div class="card-body">
                              ...
                              <form action="<?= base_url('pelanggaran/add') ?>" method="post"
                                   ...
                                   <div class="row ">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                             <label for="perLanggar"><span
                                                       class="text-danger font-weight-bold font-italic">* </span>
                                                  Perusahaan :</label><br>
                                             <select id='perLanggar' name='perLanggar'
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                             ...
                                             <input id='txtKTPKaryLanggar' name='txtKTPKaryLanggar' class="form-control"
                                                  value="<?= set_value('txtKTPKaryLanggar'); ?>" readonly>
                                             <input id='authKTPKaryLanggar' name='authKTPKaryLanggar' type="hidden"
                                                  value="<?= set_value('authKTPKaryLanggar'); ?>"><br>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                             <label for="txtNIKKaryLanggar">NIK :</label>
                                             <input id='txtNIKKaryLanggar' name='txtNIKKaryLanggar' class="form-control"
                                                  value="<?= set_value('txtNIKKaryLanggar'); ?>" readonly>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                                             <label for="txtNamaKaryLanggar">Nama Karyawan :</label>
                                             <input id='txtNamaKaryLanggar' name='txtNamaKaryLanggar'
                                                  class="form-control" value="<?= set_value('txtNamaKaryLanggar'); ?>"
                                                  readonly><br>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                             <label for="txtDepartKaryLanggar">Departemen :</label>
                                             <input id='txtDepartKaryLanggar' name='txtDepartKaryLanggar'
                                                  class="form-control" value="<?= set_value('txtDepartKaryLanggar'); ?>"
                                                  readonly><br>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                             <label for="txtPosisiKaryLanggar">Posisi :</label>
                                             <input id='txtPosisiKaryLanggar' name='txtPosisiKaryLanggar'
                                                  class="form-control" value="<?= set_value('txtPosisiKaryLanggar'); ?>"
                                                  readonly><br>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-12">
                                             <label for="tglLanggar"><span
                                                       class="text-danger font-weight-bold font-italic">* </span>Tgl.
                                                  Pelanggaran :</label>
                                             <input id='tglLanggar' name='tglLanggar' type="date" autocomplete="off"
                                                  spellcheck="false" class="form-control"
                                                  value="<?= set_value('tglLanggar'); ?>">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12">
                                             <label for="tglAkhirPunish"><span
                                                       class="text-danger font-weight-bold font-italic">* </span>Tgl.
                                                  Berakhir Disciplinary Action :</label>
                                             <input id='tglAkhirPunish' name='tglAkhirPunish' type="date"
                                                  autocomplete="off" spellcheck="false" class="form-control"
                                                  value="<?= set_value('tglAkhirPunish'); ?>">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12">
                                             <label for="jenisPunish" style="margin-bottom:15px;"><span
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                             ...
                                             <textarea id='ketLanggar' name='ketLanggar' type="text" autocomplete="off"
                                                  spellcheck="false"
                                                  class="form-control"><?= set_value('ketLanggar'); ?></textarea>
                                             <small id="error7"
                                                  class="text-danger font-italic font-weight-bold"></small>
                                             <?= form_error('ketLanggar', '<small class="text-danger font-italic font-weight-bold">', '</small>'); ?><br>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                             <label for=""><span class="text-danger font-weight-bold font-italic">*
                                                  </span>Berkas Disciplinary Action <span
                                                       class="text-danger font-weight-bold font-italic">(Berkas dengan
                                                       format pdf, ukuran maksimal 100 kb)</span> :</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                             <hr class="mb-2">
                                             <button type="submit" id="btnSubLanggar" name="btnSubLanggar"
                                                  class="btn font-weight-bold btn-primary">Buat Data</button>
                                             <a href='<?= base_url('pelanggaran/new') ?>'
