                         ...
                         <form action="<?= base_url('pelanggaran/update') ?>" method="POST">
                                   ...
                                   <div class="row">
                                        <div class="col-lg-12">
                                             ...
                                             <div class="row">
                                                  ...
                                                  <div class="col-lg-12 col-md-12 col-sm-12">
                                                       <label for="txtCariKaryLgrEdit"><span
                                                                 class="text-danger font-weight-bold font-italic">*
                                                            </span> Cari Karyawan (Ketikkan No. KTP/ NIK / Nama
                                                            Karyawan) :</label>
                                                       <input id='txtCariKaryLgrEdit' name='txtCariKaryLgrEdit'
                                                            type="text" autocomplete="off" spellcheck="false"
                                                            class="form-control"
                                                            placeholder="Ketikkan No. KTP/ NIK / Nama Karyawan"
                                                            value="">
                                                       <input type="hidden" id="authprsLgrEdit" name="authprsLgrEdit"
                                                            value="<?= $langgar['auth_m_per']; ?>"></small>
                                                       <input type="hidden" id="authLgrEdit" name="authLgrEdit"
                                                            value="<?= $langgar['auth_langgar']; ?>"></small>
                                                       <input type="hidden" id="authkary" name="authkary"
                                                            value="<?= $langgar['auth_kary']; ?>"></small>
                                                       <?= form_error('authkary', '<small class="text-danger font-italic font-weight-bold">', '</small>'); ?><br>
                                                  </div>
                                                  <div class="col-lg-3 col-md-3 col-sm-12">
                                                       <label for="">No. KTP :</label><br>
                                                       <input id="txtKTPKaryLgrEdit" name="txtKTPKaryLgrEdit"
                                                            type="text" autocomplete="off" spellcheck="false"
                                                            class="form-control" value="<?= $langgar['no_nik']; ?>"
                                                            readonly><br>
                                                  </div>
                                                  <div class="col-lg-3 col-md-3 col-sm-12">
                                                       <label for="">NIK :</label><br>
                                                       <input id="txtNIKKaryLgrEdit" name="txtNIKKaryLgrEdit"
                                                            type="text" autocomplete="off" spellcheck="false"
                                                            class="form-control" value="<?= $langgar['no_nik']; ?>"
                                                            readonly><br>
                                                  </div>
                                                  <div class="col-lg-6 col-md-6 col-sm-12">
                                                       ...
                                                       <input id="txtNamaKaryLgrEdit" name="txtNamaKaryLgrEdit"
                                                            type="text" autocomplete="off" spellcheck="false"
                                                            class="form-control"
                                                  ...
                                                  <div class="col-lg-6 col-md-6 col-sm-12">
                                                       ...
                                                       <input id="txtDepartKaryLgrEdit" name="txtDepartKaryLgrEdit"
                                                            type="text" autocomplete="off" spellcheck="false"
                                                            class="form-control" value="<?= $langgar['depart']; ?>"
                                                            readonly><br>
                                                  </div>
                                                  <div class="col-lg-6 col-md-6 col-sm-12">
                                                       <label for="">Posisi :</label><br>
                                                       <input id="txtPosisiKaryLgrEdit" name="txtPosisiKaryLgrEdit"
                                                            type="text" autocomplete="off" spellcheck="false"
                                                            class="form-control" value="<?= $langgar['posisi']; ?>"
                                                            readonly><br>
                                                  </div>
                                                  <div class="col-lg-3 col-md-6 col-sm-12">
                                                       <label for="tglLgrEdit">Tgl Pelanggaran :</label><br>
                                                       <input type="date" id="tglLgrEdit" name="tglLgrEdit"
                                                            autocomplete="off" spellcheck="false" class="form-control"
                                                            value="<?= $langgar['tgl_langgar']; ?>">
                                                       <?= form_error('tglLgrEdit', '<small class="text-danger font-italic font-weight-bold">', '</small>'); ?><br>
                                                  </div>
                                                  <div class="col-lg-3 col-md-6 col-sm-12">
                                                       <label for="tglPunishLgrEdit">Tgl. Berlaku Disciplinary Action
                                                            :</label><br>
                                                       <input type="date" id="tglPunishLgrEdit" name="tglPunishLgrEdit"
                                                            autocomplete="off" spellcheck="false" class="form-control"
                                                            value="<?= $langgar['tgl_punishment']; ?>">
                                                       <?= form_error('tglPunishLgrEdit', '<small class="text-danger font-italic font-weight-bold">', '</small>'); ?><br>
                                                  </div>
                                                  <div class="col-lg-3 col-md-6 col-sm-12">
                                                       <label for="tglAkhirPunishLgrEdit">Tgl. Akhir Disciplinary Action
                                                            :</label><br>
                                                       <input type="date" id="tglAkhirPunishLgrEdit"
                                                            name="tglAkhirPunishLgrEdit" autocomplete="off"
                                                            spellcheck="false" class="form-control bg-white"
                                                            value="<?= $langgar['tgl_akhir_langgar']; ?>">
                                                       <?= form_error('tglAkhirPunishLgrEdit', '<small class="text-danger font-italic font-weight-bold">', '</small>'); ?><br>
                                                  </div>
                                                  <div class="col-lg-3 col-md-6 col-sm-12">
                                                       <label for="jenisLgrEdit" style="margin-bottom:15px;">Jenis
                                                            Disciplinary Action :</label><br>
                                                       <select type="text" id="jenisLgrEdit" name="jenisLgrEdit"
                                                            autocomplete="off" spellcheck="false" class="form-control"
                                                            value="">
                                                            <?php
                                                            ...
                                                            <option value='<?= $list->auth_langgar_jenis; ?>'
                                                                 <?= $langgar['auth_langgar_jenis'] == $list->auth_langgar_jenis ? 'selected' : ''  ?>>
                                                                 <?= $list->langgar_jenis; ?></option>";
                                                            <?php }
                                                            } else {
                                                  ...
                                                  <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                                                       ...
                                                       <textarea id="ketLgrEdit" name="ketLgrEdit" autocomplete="off"
                                                            spellcheck="false"
                                                            class="form-control bg-white"><?= $langgar['ket_langgar']; ?></textarea>
                                                       <?= form_error('ketLgrEdit', '<small class="text-danger font-italic font-weight-bold">', '</small>'); ?><br>
                                                  </div>
                                                  <div class="col-lg-12 col-md-12 col-sm-12">
                                                       <a href="<?= $langgar['url_langgar'] ?>" target="_blank"
                                                            id="btnBerkasTampil" name="btnBerkasTampil" type="button"
                                                            class="btn font-weight-bold btn-primary">Berkas
                                                            Disciplinary Action</a>
                                                       <button id="btnGantiBerkas" name="btnGantiBerkas" type="button"
                              ...
                              <div class="modal-footer d-flex justify-align-content-end p-2" style="margin-top:5px;">
                                   <button type="submit" type="button"
                                        class="btn font-weight-bold btn-primary">Update</button>
     ...
     <div class="modal-dialog modal-dialog-centered" role="document"
          ...
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-12">
                              <label for="">No. KTP :</label><br>
                              <input type="text" autocomplete="off" spellcheck="false" class="form-control bg-white"
                                   value="<?= $langgar['no_nik']; ?>" readonly></small><br>
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <label for=""><span class="text-danger font-weight-bold font-italic">* </span>Berkas
                                   Disciplinary Action <span class="text-danger font-weight-bold font-italic">(Berkas
                                        dalam
                                        format pdf, ukuran maksimal 300 kb)</span> :</label>
               ...
               <div class="modal-footer d-flex justify-content-end p-2" style="margin-top:10px;">
                    <button type="button" id="btnUploadBerkas" id="btnUploadBerkas"
                         class="btn font-weight-bold btn-primary">Upload Berkas</button>
