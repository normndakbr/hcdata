               ...
               <div class="col-xl-12 col-md-12">
                    <div class="card latest-update-card">
                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        <a href="<?= base_url('perjanjian'); ?>" class="btn btn-primary font-weight-bold">Refresh / Data</a>
                                        <a id="addbtn" href="<?= base_url('perjanjian/new'); ?>" class="btn btn-success font-weight-bold">Tambah Data</a>
                                   </div>
                              ...
                              <div class="row">
                                   <div class="col-lg-12">
                                        <div class="table-responsive">
                                             <table id="tbmStatJanji" class="table table-striped table-bordered table-hover text-black" style="width:100%;font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                                                  <thead>
