                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        ...
                                        <a id="addbtn" href="<?=base_url('tambahlevel');?>"
...
?>
                                   ...
                                   <div class="col-lg-6 col-md-12 col-sm-12 mt-2">
                                        ...
                                        <select id='perLevelData' name='perLevelData'
                              ...
                              <div class="row">
                                   ...
                                   <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <textarea id='detailLevelKet' type="text" autocomplete="off" spellcheck="false"
                                             class="form-control form-control-user bg-white" value=""
          ...
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         <div class="col-lg-12">
                              <div
                                   class="alert alert-danger err_psn_edit_Level animate__animated animate__bounce d-none">
                              </div>
                              <div class="row">
                                   <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <input id='editLevelKode' type="text" autocomplete="off" spellcheck="false"
                                             class="form-control form-control-user bg-white" value="">
                                        <small id="error1el"
                                             class="text-danger font-italic font-weight-bold"></small><br>
                                   </div>
                                   <div class="col-lg-6 col-md-6 col-sm-12">
                                   ...
                                   <div class="modal-footer d-flex justify-content-center" style="margin-top:10px;">
                                        <button type="button" id="btnupdateLevel"
