                              ...
                              <div class="row">
                                   ...
                                   <div class="col-lg-3 col-md-3 col-sm-12">
                                        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                             ...
                                             <li><a class="nav-link text-left has-ripple active"
                                                       id="v-pills-dtPersonal-tab" data-toggle="pill"
                                                       href="#v-pills-dtPersonal" role="tab"
                                             ...
                                             <li><a class="nav-link text-left has-ripple" id="v-pills-dtSIMPER-tab"
                                                       ...
                                                       aria-controls="v-pills-dtSIMPER"
                                                       aria-selected="false">SIMPER/Mine Permit<span
                                             ...
                                             <li><a class="nav-link text-left has-ripple" id="v-pills-dtSertifikasi-tab"
                                                       ...
                                                       aria-controls="v-pills-dtSertifikasi"
                                                       aria-selected="false">Sertifikasi<span
                                                            class="ripple ripple-animate"
                                             ...
                                             <li><a class="nav-link text-left has-ripple" id="v-pills-dtVaksin-tab"
                                                       ...
                                                       aria-controls="v-pills-dtVaksin"
                                                       aria-selected="false">Vaksin<span class="ripple ripple-animate"
                                                            style="height: 373.25px; width: 373.25px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(70, 128, 255); opacity: 0.4; top: -168.188px; left: -119.625px;"></span></a>
                                             </li>
                                             <li><a class="nav-link text-left has-ripple"
                                                       id="v-pills-dtFilePendukung-tab" data-toggle="pill"
                                                       href="#v-pills-dtFilePendukung" role="tab"
                                                       aria-controls="v-pills-dtFilePendukung"
                                                       aria-selected="false">File Pendukung<span
                                                            class="ripple ripple-animate"
                                                            style="height: 373.25px; width: 373.25px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(70, 128, 255); opacity: 0.4; top: -168.188px; left: -119.625px;"></span></a>
                                             </li>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                                            <div class="m-b-25">
                                                                 <img style="border: 10px solid #3c3c3c;"
                                                                      src="<?=$data_kary->url_foto != '' ? base_url() . 'berkas/foto/' . $data_kary->id_m_perusahaan . '/' . $data_kary->url_foto : '../../berkas/pasphoto/pasphoto.jpg'?>"
...
if (!empty($data_izin)) {
    foreach ($data_izin as $list) {
        ...
        if ($list->url_izin_tambang != "") {
            if ($list->id_jenis_izin_tambang == 1) {
                                                                                          echo '<a href ="' . base_url('karyawan/berkasizin/') . $list->auth_izin_tambang . '" target="_blank" class="btn btn-primary btn-sm text-white" title="Tampilkan MINE PERMIT"><i class="far fa-file-pdf"></i></a>';
                                                                                     } else {
                                                                                          ...
                                                                                          echo '<a href ="' . base_url('karyawan/berkasizin/') . $list->auth_izin_tambang . '" target="_blank" class="btn btn-primary btn-sm text-white" title="Tampilkan SIMPER"><i class="far fa-file-pdf"></i></a>';
                                                                                     }        } else {
