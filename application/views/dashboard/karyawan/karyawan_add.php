                                                  ...
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noKTP"> No. KTP <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="namaLengkap">Nama Lengkap <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="alamatKTP">Alamat <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="provData">Provinsi <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="kecData">Kecamatan <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="kelData">Kelurahan <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addagama">Agama <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noBPJSTK">No. BPJS Tenaga Kerja </label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noBPJSKES">No. BPJS Kesehatan </label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noNPWP">No. NPWP </label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noKK">No. Kartu Keluarga <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="email">Email Pribadi </label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noTelp">No. Telp </label>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noktpshow"> No. KTP <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <label class="font-weight-bold" for="addPerKary" class="font-weight-bold font-italic">Pilih Perusahaan <span class="text-danger"> *</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addNIKKary">Nomor Induk Karyawan (NIK) <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addPOHKary">Point of Hire <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-3 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addDOH">Date of Hire <span class="text-danger">*</span></label>
                                                       ...
                                                       <div id="addFieldKontrakAkhir" class="col-lg-4 col-md-4 col-sm-12 d-none">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addTanggalKontrakAkhir">Tanggal Berakhir <span class="text-danger">*</span></label>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addNoReg">No. Register <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12 mb-3">
                                                            <div class="row">
                                                                 <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                                                      ...
                                                                      <div class="form-group">
                                                                           <label class="font-weight-bold" for="simpermp"><b>Upload SIMPER/MINE PERMIT </b> <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addTglExp">Tanggal Expired Izin <span class="text-danger">*</span></label>
                                                       ...
                                                       <div id="txtsim" class="col-lg-12 col-md-12 col-sm-12 mb-3 d-none">
                                                            <div class="row">
                                                                 ...
                                                                 <div class="col-lg-6 col-md-6 col-sm-12">
                                                                      <div class="form-group">
                                                                           <label class="font-weight-bold" for="addTglExpSIM">Tanggal Expired SIM <span class="text-danger">*</span></label>
                                                                 ...
                                                                 <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                                                      ...
                                                                      <div class="form-group">
                                                                           <label class="font-weight-bold" for="filesimpolisi"><b>Upload SIM Polisi</b> <span class="text-danger">*</span></label>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-4 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="noSertifikat">No. Sertifikasi <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-8 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="namaLembaga">Nama Lembaga <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="masaBerlakuSertifikat">Masa Berlaku (Tahun) </label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="tanggalSertifikasiAkhir">Tanggal Expired <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                                            ...
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="fileSertifikasi"><b>Upload file sertifikat</b> :</label>
                                        ...
                                        <div class="collapse mt-2" id="colMCU">
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="tglMCU">Tanggal MCU <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-8 col-md-8 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="hasilMCU">Hasil MCU <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="ketMCU">Keterangan <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="fileMCU">Upload file MCU :</label>
                                                  ...
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div id="jnsVaksin" class="form-group">
                                                                 <label class="font-weight-bold" for="jenisVaksin">Jenis Vaksin <span class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div id="nmVaksin" class="form-group">
                                                                 <label class="font-weight-bold" for="namaVaksin">Nama Vaksin <span class="text-danger">*</span></label>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12 ">
                                                            ...
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="filePendukung"><b>Upload file pendukung <span class="text-danger">*</span></b></label>
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <div class="row">
                                   ...
                                   <div class="tglnonaktif col-lg-4 col-md-4 col-sm-12">
                                        <div class="form-group">
                                             <label class="font-weight-bold" for="tglNonAktifDet">Tanggal NonAktif</label>
                    ...
                    <div class="row">
                         <div class="col-lg-12">
                              ...
                              <div class="row p-2">
                                   ...
                                   <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label class="font-weight-bold" for="tipeAksesUnit">Izin Akses Unit :</label><br>
          ...
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         ...
                         <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="masaBerlakuSertifikatEdit">Masa Berlaku (Tahun) :</label>
          ...
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         ...
                         <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="tanggalSertifikasiAkhirDetail">Tanggal Expired :</label>
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                              ...
                              <div class="form-group">
                                   <label class="font-weight-bold" for="fileSertifikasiUlang"><b>Upload file sertifikat</b> :</label>
     ...
     <div class="modal-dialog modal-dialog-centered" role="document" style="margin-left: auto; margin-right: auto;max-width:60%;">
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <label class="font-weight-bold" for="addPerKary" class="font-weight-bold font-italic">Pilih perusahaan untuk memulai isi data karyawan<span class="text-danger"> *</span></label>
                              <div id='txtperkary' class="input-group">
