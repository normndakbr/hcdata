...
?>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="kotaData">Kabupaten / Kota <span
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="kewarganegaraan">Warga Negara <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="jenisKelamin">Jenis Kelamin <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="statPernikahan">Status Pernikahan <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="tanggalLahir">Tanggal Lahir <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="pendidikanTerakhir">Pendidikan Terakhir <span
                                                                           class="text-danger">*</span></label>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-8 col-md-8 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="namalengkapshow">Nama Lengkap <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addKlasifikasiKary">Klasifikasi <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addLokterimaKary">Lokasi Penerimaan <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addLokasiKerja">Lokasi Kerja <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-6 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addStatusResidence">Status Residence <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-3 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addTanggalAktif">Tanggal Aktif <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addEmailKantor">Email Perusahaan </label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addStatusKaryawan">Status Karyawan <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div id="addFieldPermanen"
                                                            class="col-lg-4 col-md-4 col-sm-12 d-none">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addTanggalPermanen">Tanggal Permanen <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div id="addFieldKontrakAwal"
                                                            ...
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addTanggalKontrakAwal">Tanggal Awal <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div id="addFieldKontrakAkhir"
                                                            ...
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addTanggalKontrakAkhir">Tanggal Berakhir
                                                                      <span class="text-danger">*</span></label>
                                   ...
                                   <div class="col-md-12 col-sm-12 mt-2">
                                        <button id="clIzinTambang-click" class="btn btn-primary w-100"
                                             style="text-align:left;">
                                             <a class="text-white" data-toggle="collapse" href="#!" role="button"
                                                  aria-expanded="false">
                                                  3. SIMPER / Mine Permit
                                             </a>
                                             <img id="imgIzinTambang" src="<?=base_url('assets/images/checked.png')?>"
                                                  alt="" height="25px" width="25px" class="d-none"
                                                  style="margin-left:10px;margin-top:-3px;">
                                        </button>
                                        <div class="collapse mt-2" id="colIzinTambang">
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div
                                                                 class="alert alert-danger errormsgizin animate__animated animate__bounce d-none">
                                                            </div>
                                                       </div>
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                       ...
                                                       <div class="col-lg-3 col-md-3 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="addJenisIzin">Jenis Izin <span
                                                                           class="text-danger">*</span></label>
                                                                 <select id='addJenisIzin' name='addJenisIzin'
                                                                      class="form-control form-control-user" disabled>
                                                                      <option value="">-- WAJIB DIPILIH --</option>
                                                                 ...
                                                                 <small
                                                                      class="erroraddJenisIzin text-danger font-italic font-weight-bold"></small>
                                                                 <span
                                                                      class="ecb14fe704e08d9df8e343030bbbafcb d-none"></span>
                                                            </div>
                                                       </div>
                                                       <div class="col-lg-9 col-md-9 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addNoReg">No.
                                                                      Register <span
                                                                           class="text-danger">*</span></label>
                                                                 <input id='addNoReg' name='addNoReg' type="text"
                                                                      class="form-control form-control-user" disabled>
                                                                 <small
                                                                      class="erroraddNoReg text-danger font-italic font-weight-bold"></small>
                                                            </div>
                                                       </div>
                                                       <div id="txtsim"
                                                            class="col-lg-12 col-md-12 col-sm-12 mb-3 d-none">
                                                            <div class="row">
                                                                 <div class="col-lg-3 col-md-6 col-sm-12">
                                                                      <div class="form-group">
                                                                           <label class="font-weight-bold"
                                                                                for="addJenisSIM">Jenis SIM <span
                                                                                     class="text-danger">*</span></label>
                                                                           <div id="txtizinSIM"
                                                                                class="input-group mt-2">
                                                                                <select id='addJenisSIM'
                                                                                     name='addJenisSIM'
                                                                                     class="form-control form-control-user"
                                                                                     disabled>
                                                                                ...
                                                                                <div class="input-group-prepend">
                                                                                     <button id="refreshJenisSIM"
                                                                                          name="refreshJenisSIM"
                                                                                          class="btn btn-primary btn-sm"
                                                                                          disabled><i
                                                                                               class="fas fa-sync-alt"></i></button>
                                                                                </div>
                                                                           ...
                                                                           <small
                                                                                class="erroraddJenisSIM text-danger font-italic font-weight-bold"></small>
                                                                      </div>
                                                                 </div>
                                                                 <div class="col-lg-3 col-md-6 col-sm-12">
                                                                      <div class="form-group">
                                                                           <label class="font-weight-bold"
                                                                                for="addTglExpSIM">Tanggal Expired SIM
                                                                                <span
                                                                                     class="text-danger">*</span></label>
                                                                           <input id='addTglExpSIM' name='addTglExpSIM'
                                                                                type="date"
                                                                                class="form-control form-control-user"
                                                                                disabled>
                                                                           <small
                                                                                class="erroraddTglExpSIM text-danger font-italic font-weight-bold"></small>
                                                                      </div>
                                                                 </div>
                                                                 <div class="col-lg-6 col-md-12 col-sm-12">
                                                                      <label class="font-weight-bold"
                                                                           for="addTglExpSIM"> Upload SIM Polisi dalam
                                                                           format pdf,
                                                                      ...
                                                                      <div class="input-group">
                                                                           ...
                                                                           <div class="input-group-append">
                                                                                <a href="#!" id="btnshowsimpol"
                                                                                     target="_blank"
                                                                                     class="btn btn-success font-weight-bold"
                                                                                     title="Tampilkan file" disabled><i
                                                                                          class="fas fa-file-pdf"></i></a>
                                                                           </div>
                                                                      </div>
                                                                      <small
                                                                           class="errorFilesimpolisi text-danger font-italic font-weight-bold"></small>
                                                                      <span
                                                                           class="h52k342 j8234234b n234b5b7 kl234nn d-none"></span>
                                                            ...
                                                            <div class="input-group">
                                                                 <div class="custom-file">
                                                                      <input type="file" class="custom-file-input"
                                                                           id="simpermp" accept=".pdf" disabled
                                                                           required>
                                                                      <label class="custom-file-label" id='lblsimpermp'
                                                                           for="simpermp"
                                                                           aria-describedby="UploadFIleSIM">Pilih
                                                                           file SIMPER/MINE PERMIT</label>
                                                                 </div>
                                                                 <div class="input-group-append">
                                                                      <a href='#!' id="btnshowsimper" target="_blank"
                                                                           class="btn btn-success font-weight-bold text-white disabled"
                                                                           title="Tampilkan file"><i
                                                                                class="fas fa-file-pdf"></i></a>
                                                                 </div>
                                                            </div>
                                                            <small
                                                                 class="errorsimpermp text-danger font-italic font-weight-bold"></small>
                                                       ...
                                                       <div class="col-lg-4 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold" for="addTglExp">Tanggal
                                                                      Expired SIMPER/MINE PERMIT <span
                                                                           class="text-danger">*</span></label>
                                                                 <input id='addTglExp' name='addTglExp' type="date"
                                                                      class="form-control form-control-user" disabled>
                                                                 <small
                                                                      class="erroraddTglExp text-danger font-italic font-weight-bold"></small>
                                                            </div>
                                                       </div>
                                                       <div id="txtunit" class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="row">
                                                                 ...
                                                                 <div
                                                                      class="collapse col-lg-12 col-md-12 col-sm-12 simperunit">
                                                                      <a id="addUnitSIMPER" href="#!"
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12 text-right">
                                                            <a id="addKembaliIzinUnit" data-scroll href="#clKaryawan"
                                                                 class="btn btn-warning font-weight-bold disabled">Kembali</a>
                                                            <a id="addSimpanIzinUnit" data-scroll href="#clSertifikasi"
                                                                 class="btn btn-primary font-weight-bold disabled"
                                                                 style="margin-left:30px;">Simpan & Lanjutkan</a>
                                                       </div>
                                                  </div>
                                             ...
                                             <div class="card card-body">
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="jenisSertifikasi">Jenis Sertifikasi <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="tanggalSertifikasi">Tanggal Sertifikasi <span
                                                                           class="text-danger">*</span></label>
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="masaBerlakuSertifikat">Masa Berlaku (Tahun)
                                                                 </label>
                                                  ...
                                                  <div class="card-body row mt-3">
                                                       ...
                                                       <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <div id="tglVaksin" class="form-group">
                                                                 <label class="font-weight-bold"
                                                                      for="tanggalVaksin">Tanggal Vaksin <span
                                                                           class="text-danger">*</span></label>
                                                            ...
                                                            <div class="input-group">
                                                                 <div class="custom-file">
                                                                      ...
                                                                      <label class="custom-file-label"
                                                                           ...
                                                                           aria-describedby="UploadFIleSIM">Pilih file
                                                                           foto karyawan</label>
                                                                 </div>
                                                            </div>
                                                            <span
                                                            ...
                                                            <div class="input-group">
                                                                 <div class="custom-file">
                                                                      ...
                                                                      <label class="custom-file-label"
                                                                           ...
                                                                           aria-describedby="uploadpendukung">Pilih file
                                                                           pendukung</label>
                                                                 </div>
                                                            </div>
                                                            <span
                              ...
                              <div class="row p-2">
                                   <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div id="txtjenisUnitSimper" class="input-group">
                                             <select id='jenisUnitSimper' class="form-control form-control-user"
                                                  required>
                                                  <option value="">-- WAJIB DIPILIH --</option>
                                             </select>
                                             <div class="input-group-prepend">
                                   ...
                                   <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <small
                                             class="errortipeAksesUnit text-danger font-italic font-weight-bold"></small><br>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <div class="form-group">
                                   ...
                                   <small
                                        class="errorjenisSertifikasiEdit text-danger font-italic font-weight-bold"></small>
                         ...
                         <div class="col-lg-4 col-md-12 col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input id='noSertifikatEdit' name='noSertifikatEdit' type="text" autocomplete="off"
                                        spellcheck="false" class="form-control" value="" required>
                                   <small
                                        class="errorNoSertifikatEdit text-danger font-italic font-weight-bold"></small>
                              </div>
                         </div>
                         <div class="col-lg-8 col-md-12 col-sm-12">
                              <div class="form-group">
                         ...
                         <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="form-group">
                                   ...
                                   <small
                                        class="errorTanggalSertifikasiEdit text-danger font-italic font-weight-bold"></small>
                              </div>
                         </div>
                         <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="form-group">
                         ...
                         <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="tanggalSertifikasiAkhirEdit">Tanggal Expired
                                        :</label>
                                   <input id='tanggalSertifikasiAkhirEdit' name='tanggalSertifikasiAkhirEdit'
                                        type="date" autocomplete="off" spellcheck="false" class="form-control" value=""
                                        required>
                                   <small
                                        class="errorTanggalSertifikasiAkhir text-danger font-italic font-weight-bold"></small>
                              </div>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-4 col-md-12 col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input id='noSertifikatDetail' name='noSertifikatDetail' type="text"
                         ...
                         <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="tanggalSertifikasiAkhirDetail">Tanggal Expired
                                        :</label>
                                   <input id='tanggalSertifikasiAkhirDetail' name='tanggalSertifikasiAkhirEdit'
                                        type="text" autocomplete="off" spellcheck="false" class="form-control" value=""
                                        disabled>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                              ...
                              <div class="form-group">
                                   ...
                                   <small
                                        class="errorFileSertifikasiUlang text-danger font-italic font-weight-bold"></small>
          ...
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         <div class="col-lg-12 col-md-12 col-sm-12">
                              <label class="font-weight-bold" for="addPerKary"
                                   class="font-weight-bold font-italic">Pilih perusahaan untuk memulai isi data
                         ...
                         <div class="col-lg-3 col-md-12 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="kodeMperusahaan">NIK <span
                                             class="text-danger">*</span> </label>
                         ...
                         <div class="col-lg-9 col-md-12 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="namaMperusahaan">Nama Karyawan <span
                                             class="text-danger">*</span></label>
