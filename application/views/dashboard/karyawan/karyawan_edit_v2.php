                        ...
                        <div class="row p-3">
                            ...
                            <div class="container-fluid">
                                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-uppercase" id="files-tab" data-toggle="tab" href="#files" role="tab" aria-controls="files" aria-selected="false">Berkas</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content px-5 py-3 container-fluid" id="myTabContent">
                                <div class="tab-pane fade show active" id="personalTab" role="tabpanel">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editKotaData">Kabupaten / Kota <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editKewarganegaraan">Warga Negara <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editJenisKelamin">Jenis Kelamin <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editStatPernikahan">Status Pernikahan <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editTanggalLahir">Tanggal Lahir <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNoBPJSTK">No. BPJS Tenaga Kerja </label>
                                        ...
                                        <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNoBPJSKES">No. BPJS Kesehatan </label>
                                        ...
                                        <div class="mb-3 col-lg-3 col-md-5 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editPendidikanTerakhir">Pendidikan Terakhir </label>
                                ...
                                <div class="tab-pane fade" id="employeeTab" role="tabpanel">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNIKKary">Nomor Register Pokok (NRP) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editKlasifikasiKary">Klasifikasi <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editLokterimaKary">Lokasi Penerimaan <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editStatusResidence">Status Residence <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editTanggalAktif">Tanggal Aktif <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editEmailKantor">Email Perusahaan </label>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editStatusKerjaKary">Status Karyawan <span class="text-danger">*</span></label>
                                        ...
                                        <div id="editFieldPermanen" class="mb-3 col-lg-6 col-md-6 col-sm-12 d-none">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editTanggalPermanen">Tanggal Permanen <span class="text-danger">*</span></label>
                                        ...
                                        <div id="editFieldKontrakAwal" class="mb-3 col-lg-3 col-md-3 col-sm-12 d-none">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editTanggalKontrakAwal">Tanggal Awal <span class="text-danger">*</span></label>
                                        ...
                                        <div id="editFieldKontrakAkhir" class="mb-3 col-lg-3 col-md-3 col-sm-12 d-none">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editTanggalKontrakAkhir">Tanggal Berakhir <span class="text-danger">*</span></label>
                                ...
                                <div class="tab-pane fade" id="licenseTab" role="tabpanel">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12 mb-3">
                                            ...
                                            <span class="jkj234asdf u7i8o9h6u8s34 lk3kjdff3 n3m8h6x6 d-none"><?= $data_kary->auth_perusahaan ?></span>
                                            <h6 class="text-uppercase font-weight-bold" for="editPerKary"><?= isset($data_izin->jenis_izin_tambang) ? $data_izin->jenis_izin_tambang == 'MP' ? 'Data Mine Permit' : 'Data SIMPER' : '-' ?></h6>
                                            <hr style="height: 3px; background: #404443;">
                                        ...
                                        <div class="card-body row">
                                            ...
                                            <div class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="editTglExp">Tanggal Expired Izin <span class="text-danger">*</span></label>
                                            ...
                                            <div id="fieldEditJenisSim" class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="editTglExp">Jenis SIM <span class="text-danger">*</span></label>
                                            ...
                                            <div id="fieldEditExpiredSIM" class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="editTglExp">Tanggal Expired SIM <span class="text-danger">*</span></label>
                                            ...
                                            <div id="fieldEditFileSimPolisi" class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                                ...
                                                <div class="form-group">
                                                    <label for="editFileSimPolisi"><b>Upload SIM Polisi</b> <span class="text-danger">*</span></label>
                                ...
                                <div class="tab-pane fade" id="mcuTab" role="tabpanel">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12 mb-3">
                                            <h6 class="font-weight-bold" for="editPerKary"><span><?= $data_kary->nama_perusahaan ?></span> - <span class="namalengkapshow text-uppercase"><?= $data_kary->nama_lengkap ?></span></h6>
                                            <h6 class="text-uppercase font-weight-bold" for="editPerKary">Data Medical Check Up</h6>
                                            <span class="jkj234asdf u7i8o9h6u8s34 lk3kjdff3 n3m8h6x6 d-none"><?= $data_kary->auth_perusahaan ?></span>
                                            <hr style="height: 3px; background: #404443;">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="vaccineTab" role="tabpanel">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12 mb-3">
                                            <h6 class="font-weight-bold" for="editPerKary"><span><?= $data_kary->nama_perusahaan ?></span> - <span class="namalengkapshow text-uppercase"><?= $data_kary->nama_lengkap ?></span></h6>
                                            <h6 class="text-uppercase font-weight-bold" for="editPerKary">Data Vaksinasi</h6>
                                            <span class="jkj234asdf u7i8o9h6u8s34 lk3kjdff3 n3m8h6x6 d-none"><?= $data_kary->auth_perusahaan ?></span>
                                            <hr style="height: 3px; background: #404443;">
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="margin-left: auto; margin-right: auto;max-width:70%;">
        <div class="modal-content">
            <div class="modal-header bg-c-yellow d-flex align-items-center align-middle">
                <h5 class="modal-title text-white align-middle font-weight-bold" id="jdlEditSertifikat">Edit Sertifikat</h5>
                <button data-dismiss="modal" class="btn btn-sm btn-icon btn-danger"><i class="feather icon-slash"></i></button>
            </div>
