            ...
            <div class="col-xl-12 col-md-12" style="overflow-x:auto;">
                <div id="addkry" class="card latest-update-card">
                    ...
                    <div class="card-body">
                        ...
                        <input id="editTglBuat" class="d-none"
                            value="<?= isset($data_kary->tgl_buat) ? $data_kary->tgl_buat : '-' ?>"></input>
                        <input id="valueIDKaryawan" class="d-none"
                            value="<?= isset($data_kary->id_kary) ? $data_kary->id_kary : '-' ?>"></input>

                        <!-- Auth -->
                        <input id="valueAuthPerusahaan" class="d-none"
                            value="<?= isset($data_kary->auth_perusahaan) ? $data_kary->auth_perusahaan : '-' ?>"></input>
                        <input id="valueAuthMasterPerusahaan" class="d-none"
                            value="<?= isset($data_kary->auth_m_perusahaan) ? $data_kary->auth_m_perusahaan : '-' ?>"></input>
                        <input id="valueAuthPersonal" class="d-none"
                            value="<?= isset($data_kary->auth_personal) ? $data_kary->auth_personal : '-' ?>"></input>
                        <input id="valueAuthKaryawan" class="d-none"
                            value="<?= isset($data_kary->auth_karyawan) ? $data_kary->auth_karyawan : '-' ?>"></input>
                        <input id="valueAuthIzin" class="d-none"
                            value="<?= isset($data_izin->auth_izin_tambang) ? $data_izin->auth_izin_tambang : '-' ?>"></input>

                        <!-- Data Personal -->
                        <input id="editIdPersonal" class="d-none"
                            value="<?= isset($data_kary->id_personal) ? $data_kary->id_personal : '-' ?>"></input>
                        <input id="valueNoKTPOld" class="d-none"
                            value="<?= isset($data_kary->no_ktp) ? $data_kary->no_ktp : '-' ?>"></input>
                        <input id="valueNoKKOld" class="d-none"
                            value="<?= isset($data_kary->no_kk) ? $data_kary->no_kk : '-' ?>"></input>
                        <input id="valueJenisKelamin" class="d-none"
                            value="<?= isset($data_kary->jk) ? $data_kary->jk : '-' ?>"></input>
                        <input id="valueWargaNegara" class="d-none"
                            value="<?= isset($data_kary->warga_negara) ? $data_kary->warga_negara : '-' ?>"></input>
                        <input id="valueAgama" class="d-none"
                            value="<?= isset($data_kary->id_agama) ? $data_kary->id_agama : '-' ?>"></input>
                        <input id="valueStatNikah" class="d-none"
                            value="<?= isset($data_kary->id_stat_nikah) ? $data_kary->id_stat_nikah : '-' ?>"></input>
                        <input id="valueStatPendidikan" class="d-none"
                            value="<?= isset($data_kary->id_pendidikan) ? $data_kary->id_pendidikan : ''  ?>"></input>

                        <!-- Data Alamat -->
                        <input id="valueIdAlamatKTP" class="d-none"
                            value="<?= isset($data_alamat->id_alamat_ktp) ? $data_alamat->id_alamat_ktp : '-' ?>"></input>
                        <input id="alamat_ktp" class="d-none"
                            value="<?= isset($data_alamat->alamat_ktp) ? $data_alamat->alamat_ktp : '-' ?>"></input>
                        <input id="valueProvinsi" class="d-none"
                            value="<?= isset($data_alamat->prov_ktp) ? $data_alamat->prov_ktp : '' ?>"></input>
                        <input id="valueKabupaten" class="d-none"
                            value="<?= isset($data_alamat->kab_ktp) ? $data_alamat->kab_ktp : '-' ?>"></input>
                        <input id="valueKecamatan" class="d-none"
                            value="<?= isset($data_alamat->kec_ktp) ? $data_alamat->kec_ktp : '-' ?>"></input>
                        <input id="valueKelurahan" class="d-none"
                            value="<?= isset($data_alamat->kel_ktp) ? $data_alamat->kel_ktp : '-' ?>"></input>

                        <!-- Data Karyawan -->
                        <input id="valuePerusahaan" class="d-none"
                            value="<?= isset($data_kary->auth_m_perusahaan) ? $data_kary->auth_m_perusahaan : '-' ?>"></input>
                        <input id="valueDepart" class="d-none"
                            value="<?= isset($data_kary->id_depart) ? $data_kary->id_depart : '-' ?>"></input>
                        <input id="valuePosisi" class="d-none"
                            value="<?= isset($data_kary->id_posisi) ? $data_kary->id_posisi : '-' ?>"></input>
                        <input id="valueKlasifikasi" class="d-none"
                            value="<?= isset($data_kary->id_klasifikasi) ? $data_kary->id_klasifikasi : '' ?>"></input>
                        <input id="valueTipe" class="d-none"
                            value="<?= isset($data_kary->id_tipe) ? $data_kary->id_tipe : '-' ?>"></input>
                        <input id="valueLevel" class="d-none"
                            value="<?= isset($data_kary->id_level) ? $data_kary->id_level : '-' ?>"></input>
                        <input id="valuePOH" class="d-none"
                            value="<?= isset($data_kary->id_poh) ? $data_kary->id_poh : '-' ?>"></input>
                        <input id="valueLokterima" class="d-none"
                            value="<?= isset($data_kary->id_lokterima) ? $data_kary->id_lokterima : '-' ?>"></input>
                        <input id="valueLokker" class="d-none"
                            value="<?= isset($data_kary->id_lokker) ? $data_kary->id_lokker : '-' ?>"></input>
                        <input id="valueStatTinggal" class="d-none"
                            value="<?= isset($data_kary->stat_tinggal) ? $data_kary->stat_tinggal : '-' ?>"></input>
                        <input id="valueIDStatTinggal" class="d-none"
                            value="<?= isset($data_kary->id_stat_tinggal) ? $data_kary->id_stat_tinggal : '' ?>"></input>
                        <input id="valueStatPerjanjian" class="d-none"
                            value="<?= isset($data_kontrak->id_stat_perjanjian) ? $data_kontrak->id_stat_perjanjian : '' ?>"></input>
                        <input id="valueKontrakKary" class="d-none"
                            value="<?= isset($data_kontrak->auth_kontrak_kary) ? $data_kontrak->auth_kontrak_kary : '-' ?>"></input>

                        <!-- data SIMPER/Mine Permit -->
                        <input id="valueJenisIzinTambang" class="d-none"
                            value="<?= isset($data_izin->jenis_izin_tambang) ? $data_izin->jenis_izin_tambang : '-' ?>"></input>
                        <input id="valueNoRegIzin" class="d-none"
                            value="<?= isset($data_izin->no_reg) ? $data_izin->no_reg : '-' ?>"></input>
                        <input id="valueTglExpired" class="d-none"
                            value="<?= isset($data_izin->tgl_expired) ? $data_izin->tgl_expired : '-' ?>"></input>
                        <input id="valueIDSim" class="d-none"
                            value="<?= isset($data_izin->id_sim) ? $data_izin->id_sim : '-' ?>"></input>
                        <input id="valueSim" class="d-none"
                            value="<?= isset($data_izin->sim) ? $data_izin->sim : '-' ?>"></input>
                        <input id="valueUrlSIMPolisi" class="d-none"
                            value="<?= isset($data_sim_kary) ? $data_sim_kary->url_file : '-' ?>"></input>
                        <input id="valueTglExpiredSimKary" class="d-none"
                            value="<?= isset($data_sim_kary) ? $data_sim_kary->tgl_exp_sim : '-' ?>"></input>
                        ...
                        <div class="row p-3">
                            ...
                            <div class="container-fluid">
                                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-uppercase" id="license-tab" data-toggle="tab"
                                            href="#licenseTab" role="tab" aria-controls="license"
                                            aria-selected="false">SIMPER/Mine Permit</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="tab-content px-5 py-3 container-fluid" id="myTabContent">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNoKTP"> No. KTP <span
                                                        class="text-danger">*</span></label>
                                                <input id='editNoKTP' name='editNoKTP' type="text" autocomplete=" off"
                                                    spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->no_ktp ?>" required>
                                                <small
                                                    class="errorEditNoKTP text-danger font-italic font-weight-bold"></small>
                                                <span class="0c09efa8ccb5e0114e97df31736ce2e3"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNamaLengkap">Nama Lengkap <span
                                                        class="text-danger">*</span></label>
                                                <input id='editNamaLengkap' name='editNamaLengkap' autocomplete="off"
                                                    spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->nama_lengkap ?>" required>
                                                <small
                                                    class="errorEditNamaLengkap text-danger font-italic font-weight-bold"></small>
                                                <span class="9d56835ae6e4d20993874daf592f6aca d-none"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-10 col-md-10 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editAlamatKTP">Alamat <span
                                                        class="text-danger">*</span></label>
                                                ...
                                                <small
                                                    class="errorEditAlamatKTP text-danger font-italic font-weight-bold"></small>
                                        ...
                                        <div class="mb-3 col-lg-1 col-md-1 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editRtKTP' name='editRtKTP' type="number" placeholder="000"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_alamat->rt_ktp ?>" pattern="/^-?\d+\.?\d*$/"
                                                    onKeyPress="if(this.value.length==4) return false;">
                                                <small
                                                    class="erroreditRtKTP text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-1 col-md-1 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editRwKTP">RW </label>
                                                <input id='editRwKTP' name='editRwKTP' type="number" placeholder="000"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_alamat->rw_ktp ?>" pattern="/^-?\d+\.?\d*$/"
                                                    onKeyPress="if(this.value.length==4) return false;">
                                                <small
                                                    class="errorEditRwKTP text-danger font-italic font-weight-bold"></small>
                                                <span class="9100fd1e98da52ac823c5fdc6d3e4ff1 d-none"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editProvData">Provinsi <span
                                                        class="text-danger">*</span></label>
                                                <div id="txtEditProv" class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditProv" name="refreshEditProv"
                                                            class="btn btn-primary btn-sm" title="Refresh Provinsi"><i
                                                                class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditProvData text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="txtEditKota" class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditKota" name="refreshEditKota"
                                                ...
                                                <small
                                                    class="errorEditKotaData text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editKecData">Kecamatan <span
                                                        class="text-danger">*</span></label>
                                                <div id="txtEditKec" class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditKec" name="refreshEditKec"
                                                            class="btn btn-primary btn-sm" title="Refresh Kecamatan"><i
                                                                class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditKecData text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editKelData">Kelurahan <span
                                                        class="text-danger">*</span></label>
                                                <div id="txtEditKel" class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditKel" name="refreshEditKel"
                                                            class="btn btn-primary btn-sm" title="Refresh Kelurahan"><i
                                                                class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditKelData text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <small
                                                    class="errorEditKewarganegaraan text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editAgama">Agama <span
                                                        class="text-danger">*</span></label>
                                                <select id="editAgama" class="mb-3 form-control">
                                                    <option value="">-- WAJIB DIPILIH --</option>
                                                </select>
                                                <small
                                                    class="errorEditAgama text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <small
                                                    class="errorEditJenisKelamin text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="txtEditNikah" class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditStatNikah" name="refreshStatNikah"
                                                            class="btn btn-primary btn-sm"
                                                ...
                                                <small
                                                    class="errorEditStatPernikahan text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editTempatLahir">Tempat Lahir <span
                                                        class="text-danger">*</span></label>
                                                <input id='editTempatLahir' name='editTempatLahir' type="text"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= isset($data_kary->tmp_lahir) ? $data_kary->tmp_lahir : '' ?>"
                                                    required>
                                                <small
                                                    class="errorEditTempatLahir text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editTanggalLahir' name='editTanggalLahir' type="date"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->tgl_lahir ?>" required>
                                                <small
                                                    class="errorEditTanggalLahir text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editNoBPJSTK' name='editNoBPJSTK' type="number"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->no_bpjstk ?>" required>
                                                <small
                                                    class="errorEditNoBPJSTK text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editNoBPJSKES' name='editNoBPJSKES' type="number"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->no_bpjskes ?>" required>
                                                <small
                                                    class="erroreditNoBPJSKES text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNoNPWP">No. NPWP </label>
                                                <input id='editNoNPWP' name='editNoNPWP' autocomplete="off"
                                                    spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->no_npwp ?>" required>
                                                <small
                                                    class="errorEditNoNPWP text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-3 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNoKK">No. Kartu Keluarga <span
                                                        class="text-danger">*</span></label>
                                                <input id='editNoKK' name='editNoKK' type="text" autocomplete="off"
                                                    spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->no_kk ?>" required>
                                                <small
                                                    class="errorEditNoKK text-danger font-italic font-weight-bold"></small>
                                        ...
                                        <div class="mb-3 col-lg-6 col-md-8 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editEmail' name='editEmail' type="text" autocomplete="off"
                                                    spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->email_pribadi ?>" required>
                                                <small
                                                    class="errorEditEmail text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-3 col-md-7 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editNoTelp">No. Telp </label>
                                                <input id='editNoTelp' name='editNoTelp' type="number"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->hp_1 ?>" required>
                                                <small
                                                    class="errorEditNoTelp text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-3 col-md-5 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="txtEditDidik" name="txtEditDidik" class="input-group mt-2">
                                                    <select id='editPendidikanTerakhir' name='editPendidikanTerakhir'
                                                        type="text" autocomplete="off" spellcheck="false"
                                                        class="custom-select" title="Refresh Pendidikan" required>
                                                        <option value="">-- PILIH PENDIDIKAN --</option>
                                                    </select>
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditDidik" name="refreshDidik"
                                        ...
                                        <div class="mt-3 col-lg-12 col-md-12 col-sm-12 text-right">
                                            <a id="editSimpanPersonal" data-scroll href="#clKaryawan"
                                                class="btn btn-primary font-weight-bold">Simpan Data</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12 mb-3">
                                            <h6 class="font-weight-bold" for="editPerKary">
                                                <span><?= $data_kary->nama_perusahaan ?></span> - <span
                                                    class="namalengkapshow text-uppercase"><?= $data_kary->nama_lengkap ?></span>
                                            </h6>
                                            <h6 class="text-uppercase font-weight-bold" for="editPerKary">Data Karyawan
                                            </h6>
                                            <span
                                                class="jkj234asdf u7i8o9h6u8s34 lk3kjdff3 n3m8h6x6 d-none"><?= $data_kary->auth_perusahaan ?></span>
                                        ...
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id="editNIKKary" name="editNIK" type="text" autocomplete="off"
                                                    spellcheck="false" class="form-control form-control-user"
                                                    value="<?= $data_kary->no_nik ?>">
                                                <small
                                                    class="errorEditNIKKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editDepartKary">Departemen <span
                                                        class="text-danger">*</span></label>
                                                <div id='txtEditDepartKary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditDepart" name="refreshEditDepart"
                                                            class="btn btn-primary btn-sm" title="Refresh Departemen"
                                                            disabled><i class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditDepartKary text-danger font-italic font-weight-bold"></small>
                                                <span class="c1492f38214db699dfd3574b2644271d d-none"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editPosisiKary">Posisi <span
                                                        class="text-danger">*</span></label>
                                                <div id='txtEditPosisiKary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditPosisi" name="refreshEditPosisi"
                                                            class="btn btn-primary btn-sm" title="Refresh Posisi"
                                                            disabled><i class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditPosisiKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="txtEditKlasifikasiKary" class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button on id="refreshEditKlasifikasi"
                                                            name="refreshEditKlasifikasi" class="btn btn-primary btn-sm"
                                                            title="Refresh Klasifikasi" disabled><i
                                                                class="fas fa-sync-alt"></i></button>
                                                        <button on id="infoEditKlasifikasi" name="infoEditKlasifikasi"
                                                            class="btn btn-warning btn-sm" title="Informasi" disabled><i
                                                                class="fas fa-info-circle"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditKlasifikasiKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="addTipeKaryawan">Golongan <span
                                                        class="text-danger">*</span></label>
                                                <div id='txtEditJeniskary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditTipe" name="refreshEditTipe"
                                                            class="btn btn-primary btn-sm" title="Refresh Golongan"
                                                            disabled><i class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditTipeKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editLevelKary">Level <span
                                                        class="text-danger">*</span></label>
                                                <div id='txtEditLevelKary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditLevel" name="refreshEditLevel"
                                                            class="btn btn-primary btn-sm" title="Refresh Level"
                                                            disabled><i class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditLevelKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editPOHKary">Point of Hire <span
                                                        class="text-danger">*</span></label>
                                                <div id='txtEditPOHKary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditPOH" name="refreshEditPOH"
                                                            class="btn btn-primary btn-sm" title="Refresh Point of Hire"
                                                            disabled><i class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="erroreEditPOHKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id='txtEditLokterimaKary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditLokterima" name="refreshEditLokterima"
                                                            class="btn btn-primary btn-sm"
                                                            title="Refresh Lokasi Penerimaan" disabled><i
                                                                class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditLokterimaKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editLokkerKary">Lokasi Kerja <span
                                                        class="text-danger">*</span></label>
                                                <div id='txtEditLokkerKary' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditLokker" name="refreshEditLokker"
                                                            class="btn btn-primary btn-sm" title="Refresh Lokasi Kerja"
                                                            disabled><i class="fas fa-sync-alt"></i></button>
                                                    </div>
                                                </div>
                                                <small
                                                    class="errorEditLokkerKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id='txtEditStatResidence' class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditResidence" name="refreshEditResidence"
                                                            class="btn btn-primary btn-sm"
                                                ...
                                                <small
                                                    class="errorEditStatusResidence text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="font-weight-bold" for="editDOH">Date of Hire <span
                                                        class="text-danger">*</span></label>
                                                <input id='editDOH' name='editDOH' type='date'
                                                    class="form-control form-control-user"
                                                    value="<?= $data_kary->doh ?>">
                                                <small
                                                    class="errorEditDOH text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editTanggalAktif' name='editTanggalAktif' type='date'
                                                    class="form-control form-control-user"
                                                    value="<?= $data_kary->tgl_aktif ?>">
                                                <small
                                                    class="errorEditTanggalAktif text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id='editEmailKantor' name='editEmailKantor' type="text"
                                                    autocomplete="off" spellcheck="false" class="form-control"
                                                    value="<?= $data_kary->email_kantor ?>" required>
                                                <small
                                                    class="errorEditEmailKantor text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id='txtEditStatKerjaKary' class="input-group mt-2">
                                                    <select id='editStatusKerjaKary' name='editStatusKerjaKary'
                                                        class="form-control form-control-user">
                                                        <option value="">-- WAJIB DIISI --</option>
                                                    </select>
                                                    <div class="input-group-prepend">
                                                        <button id="refreshEditStatKaryawan"
                                                            name="refreshEditStatKaryawan"
                                                ...
                                                <small
                                                    class="errorEditStatusKerjaKary text-danger font-italic font-weight-bold"></small>
                                            </div>
                                        </div>
                                        <div id="editFieldPermanen" class="mb-3 col-lg-6 col-md-6 col-sm-12 d-none">
                                            <div class="form-group">
                                                ...
                                                <input id='editTanggalPermanen' name='editTanggalPermanen' type="date"
                                                    class="form-control"
                                                    value="<?= isset($data_kontrak->tgl_mulai) ? $data_kontrak->tgl_mulai : '' ?>"
                                                    style="background-color:transparent;">
                                                <small
                                                    class="errorEditTanggalPermanen text-danger font-italic font-weight-bold"
                                        ...
                                        <div id="editFieldKontrakAwal" class="mb-3 col-lg-3 col-md-3 col-sm-12 d-none">
                                            <div class="form-group">
                                                ...
                                                <input id='editTanggalKontrakAwal' name='editTanggalKontrakAwal'
                                                    type="date" class="form-control"
                                                    value="<?= isset($data_kontrak->tgl_mulai) ? $data_kontrak->tgl_mulai : '' ?>"
                                                    style="background-color:transparent;">
                                                <small
                                                    class="errorEditTanggalKontrakAwal text-danger font-italic font-weight-bold"
                                                    style="font-size:13px;"></small>
                                            </div>
                                        </div>
                                        <div id="editFieldKontrakAkhir" class="mb-3 col-lg-3 col-md-3 col-sm-12 d-none">
                                            <div class="form-group">
                                                ...
                                                <input id='editTanggalKontrakAkhir' name='editTanggalKontrakAkhir'
                                                    type="date" class="form-control"
                                                    value="<?= isset($data_kontrak->tgl_akhir) ? $data_kontrak->tgl_akhir : '' ?>"
                                                    style="background-color:transparent;">
                                                <small
                                                    class="errorEditTanggalKontrakAkhir text-danger font-italic font-weight-bold"
                                                    style="font-size:13px;"></small>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 text-right">
                                            <a id="editSimpanPekerjaan"
                                ...
                                <div class="tab-pane fade" id="licenseTab" role="tabpanel">
                                    <div class="card-body row">
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12">
                                            <div
                                                class="alert alert-danger errorMsgEditIzin animate__animated animate__bounce d-none">
                                            </div>
                                        </div>
                                        <div class="mb-3 col-lg-12 col-md-12 col-sm-12 mb-3">
                                            <h6 class="font-weight-bold" for="editPerKary">
                                        ...
                                        <div class="card-body row">
                                            <div class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="editNoReg">No. Registrasi <span
                                                            class="text-danger">*</span></label>
                                                    <input id="editNoReg" name="editNoReg" type="text"
                                                        class="form-control form-control-user"
                                                        value="<?= isset($data_izin->no_reg) ? $data_izin->no_reg : '-' ?>">
                                                    <small
                                                        class="errorEditNoReg text-danger font-italic font-weight-bold"></small>
                                                </div>
                                            </div>
                                            <div class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id='editTglExp' name='editTglExp' type="date"
                                                        class="form-control form-control-user"
                                                        value="<?= isset($data_izin->tgl_expired) ? $data_izin->tgl_expired : '-' ?>">
                                                    <small
                                                        class="errorEditTglExp text-danger font-italic font-weight-bold"></small>
                                                </div>
                                            </div>

                                            <div id="fieldEditJenisSim" class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="editTglExp">Jenis SIM <span
                                                            class="text-danger">*</span></label>
                                                    ...
                                                    <select id='editJenisSIM' name='editJenisSIM'
                                                        class="form-control form-control-user">
                                                        <option value="">-- TIDAK ADA DATA --</option>
                                                    </select>
                                                    <small
                                                        class="errorEditJenisSIM text-danger font-italic font-weight-bold"></small>
                                                </div>
                                            </div>
                                            <div id="fieldEditExpiredSIM" class=" mb-3 col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="editTglExp">Tanggal Expired SIM
                                                        <span class="text-danger">*</span></label>
                                            ...
                                            <div id="fieldEditFileSimPolisi" class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                                <a href="<?= isset($data_sim_kary) ? $data_sim_kary->url_file : '-' ?>"
                                                    target="_blank"><?= isset($data_sim_kary) ? $data_sim_kary->url_file : ' ' ?></a>
                                                <div>
                                                    <h6 class="text-danger font-italic">Catatan : Upload SIM Polisi
                                                        dalam format pdf, ukuran file SIM Polisi maksimal 50 kb.</h6>
                                                </div>
                                                <div class="form-group">
                                                    <label for="editFileSimPolisi"><b>Upload SIM Polisi</b> <span
                                                            class="text-danger">*</span></label>
                                                    <input type="file" class="form-control-file" id="editFileSimPolisi">
                                                    <small
                                                        class="errorEditFileSimPolisi text-danger font-italic font-weight-bold"></small>
                                            ...
                                            <!-- <div id="tabelSIMPOL" class="col-lg-12 col-md-12 col-sm-12 mt-3">
                                                <div id="groupTbmSIMPOL" class="form-group">
                                                    <h5 class="mb-3">Data SIM Polisi</h5>
                                                    <table id="tbmSIMPOL" class="table table-striped table-bordered table-hover text-black text-nowrap" style="width:100%;font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="align-middle text-center" style="width: 19%;"> <?= isset($data_izin->tgl_expired) ? $data_izin->tgl_expired : '-' ?> </td>
                                                                <td>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 text-right">
                                            <a id="editTambahUnit" data-scroll href="#clSertifikasi"
                                                class="btn btn-success font-weight-bold"
                                                style="margin-left:30px;">Tambah Data Unit</a>
                                            <a id="editSimpanIzinUnit" data-scroll href="#clSertifikasi"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input style="background-color: none;" id='tanggalSertifikasiDetail'
                                name='tanggalSertifikasiDetail' type="text" class="form-control" value="" disabled>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            <label class="font-weight-bold" for="tanggalSertifikasiAkhirDetail">Tanggal Expired
                                :</label>
                            <input style="background-color: none;" id='tanggalSertifikasiAkhirDetail'
                                name='tanggalSertifikasiAkhirEdit' type="text" class="form-control" value="" disabled>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer p-3">
                <button type="button" name="btnEditReuploadSertifikat" id="btnEditReuploadSertifikat"
                    class="btn font-weight-bold btn-primary mr-3">Upload File</button>
...
<div class="modal fade" id="mdleditsertifikat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer p-3">
                <button type="button" name="btnSimpanEditSertifikat" id="btnSimpanEditSertifikat"
...
<div class="modal fade" id="mdlDetailMCU" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document"
        style="margin-left: auto; margin-right: auto;max-width:70%;">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <select id='jenisVaksin' autocomplete="off" spellcheck="false" class="form-control"
                                    value="" disabled>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                <label class="font-weight-bold form-label" for="namaVaksin">Nama Vaksin <span
                                        class="text-danger">*</span></label>
                                <select id='namaVaksin' autocomplete="off" spellcheck="false" class="form-control"
                                    value="" required>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                <label class="font-weight-bold form-label" for="tanggalVaksin">Tanggal Vaksin <span
                                        class="text-danger">*</span></label>
                                <input style="background-color: none;" id='tanggalVaksin' type="date" autocomplete="off"
                                    spellcheck="false" max="<?=date('Y-m-d')?>" class="form-control" value="" required>
                            </div>
                        </div>
                    </div>
                </div>
