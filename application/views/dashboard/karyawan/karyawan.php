...
<div class="modal fade" id="mdlnewfilependukung" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     ...
     <div class="modal-dialog modal-dialog-centered" role="document"
          ...
          <div class="modal-content">
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12 ">
                              <div class='text-danger font-italic'>
                                   ...
                                   <div>
                                        <ul>
                                             <li>File pendukung adalah gabungan file pdf menjadi 1 file dengan format
                                                  sebagai berikut : <b>CV, Kartu Keluarga, KTP, Ijazah.</b></li>
                              ...
                              <div class="form-group">
                                   <label for="filePendukungnew"><b>Upload file pendukung <span
               ...
               <div class="modal-footer m-3">
                    <button type="button" name="btnnewfilependukung" id="btnnewfilependukung"
                         class="btn font-weight-bold btn-primary">Upload Data</button>
                    <button name="btnbatalfilependukung" id="btnbatalfilependukung" data-dismiss="modal"
                         class="btn font-weight-bold btn-warning">Batal</button>
               </div>
          </div>
     </div>
