                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        ...
                                        <a id="addTambahKary" href="<?= base_url('new'); ?>" target="_blank" class=" btn btn-success font-weight-bold"><i class="fas fa-plus"></i>
                                             Tambah Data</a>
                                   </div>
                                   <div class="alert alert-danger err_psn_kary animate__animated animate__bounce d-none">
                                   </div>
                              </div>
                              <div class="row">
                                   <?php
                                   ...
                                   <div class="col-lg-12 col-md-12 col-sm-12">
                                        <label class="font-weight-bold">Struktur
                                             Perusahaan :</label><br>
                                        <label id="lblhirarkiper" for="lblhirarkiper" class="form-control font-weight-bold"></label><br>
                                   </div>
...
<div class="modal fade" id="mdlnewfotokaryawan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
          ...
          <div class="modal-content">
               ...
               <form action="javascript:void(0)" id="gantiFotoKaryawan" method="post" data-parsley-validate>
                    <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                         <div class="row">
                              <div class="col-lg-12 col-md-12 col-sm-12">
                                   <div class="alert errnewfotokaryawan alert-danger animate_animated animate_bounce d-none" role="alert"></div>
                              </div>
                              <div class="col-lg-12 col-md-12 col-sm-12 ">
                                   ...
                                   <div class="form-group">
                                        <label for="fotoKaryawanNew" class="form-label"><b>Foto Karyawan <span class="text-danger">*</span></b></label>
                                        <input type="file" class="form-control-file" id="fotoKaryawanNew" accept=".jpg" required>
...
<div class="modal fade" id="mdlnewSMP" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     <div class="modal-dialog modal-dialog-centered" role="document" style="margin-left: auto; margin-right: auto;max-width:70%;">
          <div class="modal-content">
               <div class="modal-header bg-c-yellow">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         ...
                         <div class="col-lg-3 col-md-3 col-sm-12">
                              <div class="form-group">
                                   <label class="font-weight-bold" for="addJenisIzinnew">Jenis Izin <span class="text-danger">*</span></label>
                         ...
                         <div class="col-lg-9 col-md-9 col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input id='addNoRegnew' name='addNoRegnew' type="text" class="form-control form-control-user">
                         ...
                         <div id="txtsimnew" class="col-lg-12 col-md-12 col-sm-12 mb-3 d-none">
                              <div class="row">
                                   <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="form-group">
                                             <label class="font-weight-bold" for="addJenisSIMnew">Jenis SIM <span class="text-danger">*</span></label>
                                             <div id="txtizinSIM" class="input-group">
                                                  <select id='addJenisSIMnew' name='addJenisSIMnew' class="form-control form-control-user">
                                                       <option value="">-- SIM TIDAK ADA
                                                            --</option>
                                                  </select>
                                                  <div class="input-group-prepend">
                                                       <button id="refreshJenisSIMnew" name="refreshJenisSIMnew" class="btn btn-primary btn-sm"><i class="fas fa-sync-alt"></i></button>
                                                  </div>
                                             </div>
                                   ...
                                   <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="form-group">
                                             ...
                                             <input id='addTglExpSIMnew' name='addTglExpSIMnew' type="date" class="form-control form-control-user">
                                             <small class="erroraddTglExpSIMnew text-danger font-italic font-weight-bold"></small>
                                        </div>
                                   </div>
                                   <div class="col-lg-6 col-md-12 col-sm-12">
                                        ...
                                        <div class="input-group">
                                             <div class="custom-file">
                                                  <input type="file" class="custom-file-input " id="filesimpolisinew" accept=".pdf">
                                                  <label class="custom-file-label" id='lblsimpolisinew' for="filesimpolisinew" aria-describedby="UploadFIleSIM">Pilih
                                                       file SIM Polisi</label>
                                             </div>
                                             <div class="input-group-append">
                                                  <a href="#!" id="btnshowsimpolnew" target="_blank" class="btn btn-success font-weight-bold disabled" title="Tampilkan file"><i class="fas fa-file-pdf"></i></a>
                                             </div>
                                        </div>
                         ...
                         <div class="col-lg-8 col-md-12 col-sm-12">
                              ...
                              <div class="input-group">
                                   <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" id='lblsimpermpnew' for="simpermpnew" aria-describedby="UploadFIleSIM">Pilih
                                             file SIMPER/MINE PERMIT</label>
                                   </div>
                                   <div class="input-group-append">
                                        <a href='#!' id="btnshowsimpernew" target="_blank" class="btn btn-success font-weight-bold text-white disabled" title="Tampilkan file"><i class="fas fa-file-pdf"></i></a>
                                   </div>
                              </div>
                         ...
                         <div class="col-lg-4 col-md-12 col-sm-12">
                              <div class="form-group">
                                   ...
                                   <input id='addTglExpnew' name='addTglExpnew' type="date" class="form-control form-control-user">
                         ...
                         <div id="txtunitnew" class="col-lg-12 col-md-12 col-sm-12 d-none">
                              <div class="row">
                                   ...
                                   <div class="collapse col-lg-12 col-md-12 col-sm-12 simperunitnew">
                                        <a id="addUnitSIMPERnew" href="#!" class="btn btn-primary font-weight-bold mb-4">Tambah Unit</a>
                                        <div id="idizintambangnew" class="data"></div>
                                   </div>
                              </div>
                         </div>
                         <div class="col-lg-12 col-md-12 col-sm-12 text-right">
                              <a id="addSimpanIzinUnitnew" class="btn btn-primary font-weight-bold text-white" style="margin-left:30px;">Simpan Data</a>
                              <a id="addKembaliIzinUnitnew" class="btn btn-warning font-weight-bold text-white" data-dismiss="modal">Batal</a>
                         </div>
                    </div>
               </div>
          </div>
...
<div class="modal fade" id="mdlnewvaksin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     <div class="modal-dialog modal-dialog-centered" role="document" style="margin-left: auto; margin-right: auto;max-width:70%;">
          <div class="modal-content">
               <div class="modal-header bg-c-yellow">
                         ...
                         <div class="row">
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-12">
                                   <div id="tglVaksin" class="form-group">
                                        ...
                                        <input id='tanggalVaksin' name='tanggalVaksin' type="date" autocomplete="off" spellcheck="false" class="form-control" max="<?= date('Y-m-d') ?>" value="" required>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                         <div class="row">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 ">
                                   ...
                                   <div class="form-group">
                                        <label for="filePendukungnew" class="form-label"><b>File pendukung <span class="text-danger">*</span></b></label>
                                        <input type="file" class="form-control-file" id="filePendukungnew" accept=".pdf" required>
...
<div class="modal fade" id="mdlunitsimpernw" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
     <div class="modal-dialog modal-dialog-centered" role="document" style="margin-left: auto; margin-right: auto;max-width:50%;">
          <div class="modal-content">
               ...
               <div style="background-color:rgba(240,240,240,1);" class="modal-body">
                    <div class="row">
                         <div class="col-lg-12">
                              <div class="alert errormdlsimpernw alert-danger animate__animated animate__bounce d-none" role="alert"></div>
                              <div class="row p-2">
                                   <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div id="txtjenisUnitSimpernw" class="input-group">
                                             ...
                                             <div class="input-group-prepend">
                                                  <button id="refreshjenisUnitSimpernw" name="refreshjenisUnitSimpernw" class="btn btn-primary btn-sm" disabled><i class="fas fa-sync-alt"></i></button>
                                             </div>
                                        </div>
                                        <small class="errorjenisUnitSimpernw text-danger font-italic font-weight-bold"></small><br>
                                   </div>
                                   <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div id="txttipeAksesUnitnw" class="input-group">
                                             ...
                                             <div class="input-group-prepend">
                                                  <button id="refreshtipeAksesUnitnw" name="refreshtipeAksesUnitnw" class="btn btn-primary btn-sm" disabled><i class="fas fa-sync-alt"></i></button>
                                             </div>
                                        </div>
                                        <small class="errortipeAksesUnitnw text-danger font-italic font-weight-bold"></small><br>
                                   </div>
                              </div>
                         </div>
                    </div>
               ...
               <div class="modal-footer m-3">
                    <button type="button" name="btnsimpanunitsimpernw" id="btnsimpanunitsimpernw" class="btn font-weight-bold btn-primary">Simpan Data</button>
                    <button name="btnbatalunitsimpernw" id="btnbatalunitsimpernw" data-dismiss="modal" class="btn font-weight-bold btn-warning">Selesai</button>
               </div>
          </div>
     </div>
</div>