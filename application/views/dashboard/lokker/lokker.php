                         ...
                         <div class="card-body">
                              <div class="mt-3">
                                   <div class="mb-2">
                                        ...
                                        <a id="addbtn" href="<?= base_url('lokasikerja/new'); ?>" class="btn btn-success font-weight-bold"><i class="fas fa-plus"></i> Tambah Data</a>
                                   </div>
                              ...
                              <div class="row">
                                   ...
                                   <div class="col-lg-12">
                                        <div class="table-responsive">
                                             <table id="tbmLokker" class="table table-striped table-bordered table-hover text-black" style="width:100%;font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                                                  <thead>
