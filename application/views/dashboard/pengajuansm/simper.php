...
if (!empty($authpengajuansm)) {
     echo "<input type='hidden' id='authizintambangsp' name='authizintambangsp' value='" . $authpengajuansm . "'>";
     echo "<input type='hidden' id='tbldata' name='tbldata' value='" . $tabel . "'>";
} else {
     echo "<input type='hidden' id='authizintambangsp' name='authizintambangsp' value=''>";
...
<table id="tbmKaryMP" class="table table-striped table-bordered table-hover text-black" style="width:100%;font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
     <thead>
          <tr>
               ...
               <th>Posisi</th>
               <th>Date Of Hire</th>
               <th>Jenis SIM Polisi</th>
               <th>Tgl. Exp. SIM Polisi</th>
               <th>Tgl. Exp. SIO</th>
               <th>Proses Izin</th>
               <th>Proses</th>
          </tr>
...
<script>
     let authizinsm = $("#authpengajuansmsp").val();
     let tbldata = $("#authizintambangsp").val();
