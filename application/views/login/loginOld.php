...
<body>
                    ...
                    <form action="<?= base_url('login/auth'); ?>" method="post">,
                         <div class="card-body">
                              ...
                              <div class="text-center">
                                   <button type='submit' class="btn btn-block btn-primary font-weight-bold" style="border-radius:5px;">LOGIN</button>
                              </div>
                         </div>
                    </form>
               </div>
     ...
     <script>
          let site_url = "https://test.main-system.online/";
     </script>
     <script>
        window.history.replaceState&&window.history.replaceState(null,null,"<?= base_url(); ?>"),$(".pesan ").fadeTo(5e3,500).slideUp(500,function(){$(".pesan ").slideUp(500)}),$("#refCap").click(function(e){e.preventDefault(),$.ajax({url:site_url+"login/refCaptcha",dataType:"text",cache:!1,success:function(e){$(".captcha-img").html(e)}})});     </script>
