          ...
          <div class="auth-content" style="width:450px">
               <div class="row">
                    <div class="col-lg-12 text-center">
                         ...
                         <h4 class="mb-3 f-w-400 text-white font-weight-bold" style="margin-top: -10px;">Support
                         </h4>
                    </div>
               </div>
...
?>
                              ...
                              <div class="align-items-center text-center" style="margin-top: -35px;">
                                   <img src="<?=base_url('assets/assets/images/auth/idc.jpg');?>"
                                        alt="PT Indexim Coalindo" class="w-75 mt-1">
               ...
               <div class="text-center mt-2">
                    <small class=" font-weight-bold text-white">© 2009-2023 PT Indexim Coalindo. All rights
                         reserved.</small>
               </div>
          </div>
     </div>
